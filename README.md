# Projeto onixx.py é um programa sendo desenvolvido que ajuda usuários de cyber segurança a ter uma interface mais fácil, amigável e resumida ao usar ferramentas de segurança, como NMAP, REQUESTS etc.
